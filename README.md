...
For the curious minded, we have added 5 additional groups `Rx(2),SQ(),RxSQ(),Tx(2),Ty(2)`, Rotation, Squeezing, Rotation and Squeezing, Translation in x only, and Translation in y only.
